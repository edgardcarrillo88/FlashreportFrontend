...
export default function FlashReportModel(){
        ...
        <div >
            ...
            <form className={style.Formstyle}>
                ...
                {/* <div>
                    ...
                    <div className={style.fourcomponent}>
                        <div  className={style.twocomponent}>
                            <label className={style.labelreport}>Fotografias durante el evento</label>
                            <input type='file' name='imagebefore' id='filebefore' value={report.imagebefore} onChange={controlcambios}></input>
                        </div>
                        <div className={style.twocomponent}>
                            <label className={style.labelreport}>Fotografias despues del evento</label>
                ...
                <button className={style.FlashReportButton} onClick={enviodeformulario}>Enviar flash report</button>
            </form>
        </div>
        </Layout>
        </>
